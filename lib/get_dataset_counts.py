...
def get_counts(train_data=VG(mode='train', filter_non_overlap=False, filter_duplicate_rels=False, num_val_im=5000), must_overlap=True):
    """
    ...
    for ex_ind in range(len(train_data)):
        ...
        for (o1, o2) in o1o2_total:
            bg_matrix[o1, o2] += 1
    # np.save('fg_matrix.npy', fg_matrix)
    # exit()
