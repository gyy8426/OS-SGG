...
DATA_PATH = '/mnt/data1/***/datasets/visual_genome/data/genome/'
...
VG_IMAGES = '/mnt/data1/***/datasets/visual_genome/data/genome/VG_100K'
...
# COCO_PATH = '/mnt/data1/***/dataset/mscoco/'
# =============================================================================
# =============================================================================
...
class ModelConfig(object):
    ...
    def __init__(self):
        ...
        self.nl_edge_gcn=None
        self.bg_num_rel = None
        ...
        if self.model not in ('motifnet', 'stanford', 'freq', 'gkg'):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-nh_obj', dest='nh_obj', help='Num heads of object layers', type=int, default=1)
        parser.add_argument('-nh_edge', dest='nh_edge', help='Num heads of edge layers', type=int, default=2)
        parser.add_argument('-nl_obj_gcn', dest='nl_obj_gcn', help='Num object gcn layers', type=int, default=1)
        parser.add_argument('-nl_edge_gcn', dest='nl_edge_gcn', help='Num edge gcn layers', type=int, default=2)
        ...
        parser.add_argument('-bg_num_rel', dest='bg_num_rel', help='Num background relationship', type=int, default=256)
        parser.add_argument('-test_alpha', dest='test_alpha', help='test_alpha', type=float, default=1.0)
